...
with left_sidebar:
    ...
    # New ASCII art below the stripes
    st.markdown(r"""
```
#***+++========---------------------:::-----===--
******+++====++*@@@@@@@+----:-::::::::::---------
