...
def load_and_process_bls_data():
    ...
    data = json.dumps(
        {
            "seriesid": [
                ...
                'LNU02032554', 'LNU02032496', 'LNU02035873', 'LNU02035897', 'LNU02035964', 'LNU02035885' # New Industry Series IDs - Transportation and Material Moving
            ],
    ...
    if not df.empty:
        ...
        sn_map = {
            ...
            # Industry Series - Transportation and Material Moving Occupations
        ...
        industry_transportation_avg_df = avg_rates_latest_year[avg_rates_latest_year['series_name'].str.contains('Employment Level - Transportation and Material Moving')].copy()
        ...
        # Calculate 'proportion' for industry_transportation_avg_df
        if not industry_transportation_avg_df.empty:
            total_transportation_sum = industry_transportation_avg_df['value'].sum()
            if total_transportation_sum > 0:
                industry_transportation_avg_df['proportion'] = industry_transportation_avg_df['value'] / total_transportation_sum
            else:
                industry_transportation_avg_df['proportion'] = 0.0
        ...
        desired_order = [
            ...
            'Employment Level - Transportation and Material Moving, White',
            'Employment Level - Transportation and Material Moving, Asian',
            'Employment Level - Transportation and Material Moving, Hispanic or Latino',
            'Employment Level - Transportation and Material Moving, Black or African American'
        ]
        ...
        industry_transportation_avg_df['series_name'] = pd.Categorical(
            industry_transportation_avg_df['series_name'],
            categories=desired_order,
            ordered=True
        )
        industry_transportation_avg_df = industry_transportation_avg_df.sort_values('series_name')

        return df_filtered, latest_full_year, unemployment_avg_df, labor_force_avg_df, industry_management_avg_df, industry_service_avg_df, industry_sales_office_avg_df, industry_natural_construction_avg_df, industry_transportation_avg_df
...
def plot_rates_by_sex(avg_df, year, chart_type_prefix):
    ...
    elif chart_type_prefix == 'Employment Level - Transportation and Material Moving':
        sex_groups = [
            'Employment Level - Transportation and Material Moving, Men',
            'Employment Level - Transportation and Material Moving, Women'
        ]
    ...
    if chart_type_prefix == 'Unemployment':
        ...
        y_column = 'proportion'
        y_axis_label = 'Proportion of Transportation and Material Moving Employment'
        tick_format = '.1%'
        text_auto_format = '.1%'
...
def plot_rate_comparisons(avg_df, year, chart_type_prefix):
    ...
    if white_women_avg_series_name not in avg_df['series_name'].values:
        if chart_type_prefix == 'Employment Level - Management, Professional':
            ...
            white_women_avg_series_name = 'Employment Level - Transportation and Material Moving, Women'
            if white_women_avg_series_name not in avg_df['series_name'].values:
                return []
        else:
            return []
    ...
    comparison_order_industry_transportation = [
        'Employment Level - Transportation and Material Moving, Asian',
        'Employment Level - Transportation and Material Moving, Men',
        'Employment Level - Transportation and Material Moving, Hispanic or Latino',
        'Employment Level - Transportation and Material Moving, Black or African American'
    ...
    if chart_type_prefix == 'Unemployment':
        ...
        comparison_order = comparison_order_industry_transportation
    else:
        comparison_order = []
    ...
    label_mapping = {
        ...
        'Employment Level - Transportation and Material Moving, Asian': 'Transportation and Material Moving, Asian',
        'Employment Level - Transportation and Material Moving, Men': 'Transportation and Material Moving, Men',
        'Employment Level - Transportation and Material Moving, Hispanic or Latino': 'Transportation and Material Moving, Hispanic or Latino',
        'Employment Level - Transportation and Material Moving, Black or African American': 'Transportation and Material Moving, Black or African American'
    }
    ...
    for index, row in other_demographics_ordered.iterrows():
        ...
        if chart_type_prefix == 'Unemployment':
            ...
            white_women_avg_series_name_tr = 'Employment Level - Transportation and Material Moving, Women'
            if white_women_avg_series_name_tr not in avg_df['series_name'].values:
                return []

            white_women_avg_tr = avg_df[avg_df['series_name'] == white_women_avg_series_name_tr].iloc[0]

            white_women_proportion = white_women_avg_tr['proportion']
            row_proportion = row['proportion']

            y_column = 'proportion'
            y_axis_label = f'Proportion of Transportation and Material Moving Employment'
            chart_title = f"Average Transportation and Material Moving: Women vs. {display_comparison_group_name} in {year}"
            tick_format = '.1%'
            text_auto_format = '.1%'

            comparison_df = pd.DataFrame({
                'series_name': [white_women_avg_series_name_tr, display_comparison_group_name],
                'proportion': [white_women_proportion, row_proportion]
            })
...
with main_content:
    ...
    if st.session_state.game_stage == 'industry_visualizations':
        ...
        with viz_col[0]:
            ...
            df_filtered, latest_full_year, unemployment_avg_df, labor_force_avg_df, industry_management_avg_df, industry_service_avg_df, industry_sales_office_avg_df, industry_natural_construction_avg_df, industry_transportation_avg_df = load_and_process_bls_data()
            ...
            if not labor_force_avg_df.empty:
                ...
                if not industry_transportation_avg_df.empty:
                    st.plotly_chart(plot_management_proportion_of_labor_force_by_sex(labor_force_avg_df, industry_transportation_avg_df, latest_full_year, 'Transportation and Material Moving', '#DAA520'), use_container_width=True)
                    st.plotly_chart(plot_management_proportion_of_labor_force_by_race(labor_force_avg_df, industry_transportation_avg_df, latest_full_year, 'Transportation and Material Moving', '#DAA520'), use_container_width=True)
                    st.subheader("Mad Liberal Comparisons")
                    st.markdown("#### Check your privilege!")
                else:
                    st.warning("Cannot generate Transportation and Material Moving Occupations visualizations, data not available.")
